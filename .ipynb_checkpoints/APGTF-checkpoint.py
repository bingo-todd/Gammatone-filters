...
class APGTF:
    ...
    def plot_ir_spec(self,ir,fs=None,fig=None,is_auto_scale=True,title='ir'):
        ...
        axs = fig.subplots(1,2)
        axs[0].plot(time_ticks,ir,linewidth=2); axs[0].set_xlim([self.low_cf*1.5,self.high_cf*1.5])
        ...
        axs[1].plot(freq_ticks,spec,linewidth=2); axs[1].set_xlim([self.low_cf*1.5,self.high_cf*1.5])
